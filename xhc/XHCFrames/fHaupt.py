...
def create(parent):
    return fHaupt(parent)

[wxID_FHAUPT, wxID_FHAUPTBTNBROWSEXWINBINARY, wxID_FHAUPTBTNENDE, 
 wxID_FHAUPTBTNRUN, wxID_FHAUPTBTNSAVECONFIG, wxID_FHAUPTBTNSUCHEXWINBINARY, 
 wxID_FHAUPTCHBAUFLOESUNG, wxID_FHAUPTCHBEIGENEIP, 
 wxID_FHAUPTCHBEMULATE3BUTTONS, wxID_FHAUPTCHBFONT, wxID_FHAUPTCHBNOUNIXKILL, 
 wxID_FHAUPTCHBNOWINKILL, wxID_FHAUPTCHBONCE, wxID_FHAUPTCHBROOTLESS, 
 wxID_FHAUPTCHLANGUAGE, wxID_FHAUPTCOBAUFLOESUNG, wxID_FHAUPTCOBXWINBINARY, 
 wxID_FHAUPTCOBZIELHOST, wxID_FHAUPTNBHAUPT, wxID_FHAUPTRBBROADCAST, 
 wxID_FHAUPTRBZIELHOST, wxID_FHAUPTSTATICLINE1, wxID_FHAUPTSTBEFEHL, 
 wxID_FHAUPTSTEMULATE3BUTTONSTIMEOUT, wxID_FHAUPTSTLANGUAGE, 
 wxID_FHAUPTSTXWINBINARY, wxID_FHAUPTTCBEFEHL, wxID_FHAUPTTCEIGENEIP, 
 wxID_FHAUPTTCEMULATE3BUTTONSTIMEOUT, wxID_FHAUPTWINSETUP, 
 wxID_FHAUPTWINSTART, 
] = map(lambda _init_ctrls: wxNewId(), range(31))

class fHaupt(wxFrame):
    ...
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wxFrame.__init__(self, id=wxID_FHAUPT, name='fHaupt', parent=prnt,
        ...
        self.nbHaupt = wxNotebook(id=wxID_FHAUPTNBHAUPT, name='nbHaupt',
        ...
        EVT_NOTEBOOK_PAGE_CHANGING(self.nbHaupt, wxID_FHAUPTNBHAUPT,
              self.OnNbhauptNotebookPageChanging)
        EVT_PAINT(self.nbHaupt, self.OnTranslatableControlPaint)

        self.winStart = wxWindow(id=wxID_FHAUPTWINSTART, name='winStart',
              parent=self.nbHaupt, pos=wxPoint(0, 0), size=wxSize(360, 202),
              style=wxTAB_TRAVERSAL)

        self.winSetup = wxWindow(id=wxID_FHAUPTWINSETUP, name='winSetup',
              parent=self.nbHaupt, pos=wxPoint(0, 0), size=wxSize(360, 202),
              style=wxTAB_TRAVERSAL)

        self.cobZielhost = wxComboBox(choices=[], id=wxID_FHAUPTCOBZIELHOST,
        ...
        self.btnRun = wxButton(id=wxID_FHAUPTBTNRUN, label='Verbinden',
        ...
        EVT_BUTTON(self.btnRun, wxID_FHAUPTBTNRUN, self.OnBtnrunButton)
        EVT_PAINT(self.btnRun, self.OnTranslatableControlPaint)

        self.btnEnde = wxButton(id=wxID_FHAUPTBTNENDE, label='Beenden',
              name='btnEnde', parent=self.winStart, pos=wxPoint(264, 160),
              size=wxSize(75, 23), style=0)
        EVT_BUTTON(self.btnEnde, wxID_FHAUPTBTNENDE, self.OnBtnendeButton)
        EVT_PAINT(self.btnEnde, self.OnTranslatableControlPaint)

        self.cobAufloesung = wxComboBox(choices=['800 600', '1024 768',
              '1280 1024', '1600 1200'], id=wxID_FHAUPTCOBAUFLOESUNG,
        ...
        self.chbRootless = wxCheckBox(id=wxID_FHAUPTCHBROOTLESS,
        ...
        EVT_CHECKBOX(self.chbRootless, wxID_FHAUPTCHBROOTLESS,
              self.OnChbrootlessCheckbox)
        EVT_PAINT(self.chbRootless, self.OnTranslatableControlPaint)

        self.chbOnce = wxCheckBox(id=wxID_FHAUPTCHBONCE,
        ...
        EVT_CHECKBOX(self.chbOnce, wxID_FHAUPTCHBONCE, self.OnChbonceCheckbox)
        EVT_PAINT(self.chbOnce, self.OnTranslatableControlPaint)

        self.chbNoWinKill = wxCheckBox(id=wxID_FHAUPTCHBNOWINKILL,
        ...
        EVT_CHECKBOX(self.chbNoWinKill, wxID_FHAUPTCHBNOWINKILL,
              self.OnChbnowinkillCheckbox)
        EVT_PAINT(self.chbNoWinKill, self.OnTranslatableControlPaint)

        self.chbNoUnixKill = wxCheckBox(id=wxID_FHAUPTCHBNOUNIXKILL,
        ...
        EVT_CHECKBOX(self.chbNoUnixKill, wxID_FHAUPTCHBNOUNIXKILL,
              self.OnChbnounixkillCheckbox)
        EVT_PAINT(self.chbNoUnixKill, self.OnTranslatableControlPaint)

        self.chbEmulate3Buttons = wxCheckBox(id=wxID_FHAUPTCHBEMULATE3BUTTONS,
        ...
        EVT_CHECKBOX(self.chbEmulate3Buttons, wxID_FHAUPTCHBEMULATE3BUTTONS,
              self.OnChbemulate3buttonsCheckbox)
        EVT_PAINT(self.chbEmulate3Buttons, self.OnTranslatableControlPaint)

        self.tcEmulate3ButtonsTimeout = wxTextCtrl(id=wxID_FHAUPTTCEMULATE3BUTTONSTIMEOUT,
        ...
        EVT_TEXT(self.tcEmulate3ButtonsTimeout,
              wxID_FHAUPTTCEMULATE3BUTTONSTIMEOUT,
              self.OnTcemulate3buttonstimeoutText)

        self.stEmulate3ButtonsTimeout = wxStaticText(id=wxID_FHAUPTSTEMULATE3BUTTONSTIMEOUT,
        ...
        self.stXWinBinary = wxStaticText(id=wxID_FHAUPTSTXWINBINARY,
        ...
        self.cobXWinBinary = wxComboBox(choices=[r'C:\cygwin\usr\X11R6\bin\XWin.exe',
              ...
              r'E:\cygwin\usr\X11R6\bin\XWin.exe'], id=wxID_FHAUPTCOBXWINBINARY,
              name='cobXWinBinary', parent=self.winSetup, pos=wxPoint(96, 56),
              size=wxSize(125, 21), style=0, validator=wxDefaultValidator,
        ...
        self.tcBefehl = wxTextCtrl(id=wxID_FHAUPTTCBEFEHL, name='tcBefehl',
              parent=self.winSetup, pos=wxPoint(8, 176), size=wxSize(320, 21),
              style=0, value='tcBefehl')

        self.chbAufloesung = wxCheckBox(id=wxID_FHAUPTCHBAUFLOESUNG,
        ...
        EVT_CHECKBOX(self.chbAufloesung, wxID_FHAUPTCHBAUFLOESUNG,
              self.OnChbaufloesungCheckbox)
        EVT_PAINT(self.chbAufloesung, self.OnTranslatableControlPaint)

        self.rbZielhost = wxRadioButton(id=wxID_FHAUPTRBZIELHOST,
        ...
        EVT_RADIOBUTTON(self.rbZielhost, wxID_FHAUPTRBZIELHOST,
              self.OnRbzielhostRadiobutton)
        EVT_PAINT(self.rbZielhost, self.OnTranslatableControlPaint)

        self.rbBroadcast = wxRadioButton(id=wxID_FHAUPTRBBROADCAST,
        ...
        EVT_RADIOBUTTON(self.rbBroadcast, wxID_FHAUPTRBBROADCAST,
              self.OnRbbroadcastRadiobutton)
        EVT_PAINT(self.rbBroadcast, self.OnTranslatableControlPaint)

        self.chbFont = wxCheckBox(id=wxID_FHAUPTCHBFONT,
        ...
        EVT_CHECKBOX(self.chbFont, wxID_FHAUPTCHBFONT, self.OnChbfontCheckbox)
        EVT_PAINT(self.chbFont, self.OnTranslatableControlPaint)

        self.chbEigeneIP = wxCheckBox(id=wxID_FHAUPTCHBEIGENEIP,
        ...
        self.chLanguage = wxChoice(choices=['English', 'Deutsch'],
              id=wxID_FHAUPTCHLANGUAGE, name='chLanguage', parent=self.winSetup,
              pos=wxPoint(96, 8), size=wxSize(125, 21), style=0,
              validator=wxDefaultValidator)
        self.chLanguage.SetSelection(1)
        EVT_CHOICE(self.chLanguage, wxID_FHAUPTCHLANGUAGE,
    ...
    def __init__(self, parent):
        ...
        icon_file = os.path.join('Images', "X_swoosh_logo_32x32x16.ico")
